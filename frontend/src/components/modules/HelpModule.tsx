...
export function HelpModule() {
  ...
  const faqs: FAQItem[] = [
    ...
    // ========== STAKEHOLDER PORTAL FAQs (NEW) ==========
    { category: "🔐 Stakeholder Portal", question: "What is the Stakeholder Portal and how do I access it?", answer: "The Stakeholder Portal is a dedicated interface for project stakeholders (clients, architects, engineers, consultants) to view project progress, documents, meeting minutes, and financial summaries. ACCESS: 1) Go to https://bochi.ke/login, 2) Enter your company subdomain (provided by your project manager), 3) Enter your email address, 4) Click 'Send OTP' - a One-Time Password will be emailed to you, 5) Enter the OTP to login. No password needed - we use secure OTP authentication!", priority: "high" },
    { category: "🔐 Stakeholder Portal", question: "I received an invitation email but no password - how do I login?", answer: "BOCHI uses OTP (One-Time Password) authentication for security. You NEVER need to remember a password! Follow these steps: 1) Click the login link in your invitation email, 2) Enter your subdomain (shown in the email), 3) Enter your email address, 4) Click 'Send OTP', 5) Check your email for a 6-digit code, 6) Enter the code to login. Each login requires a new OTP - no password to remember or reset!", priority: "high" },
    { category: "🔐 Stakeholder Portal", question: "What can I see and do as a stakeholder?", answer: "Stakeholder access includes: 📊 Project Overview - progress, status, timeline; 📄 Meeting Minutes - view agendas, discussions, decisions, action items; 📁 Documents - download project documents, drawings, photos, reports; 💰 Financial Summary - contract sum, invoiced amount, payments received, outstanding balance (view only); 👥 Project Team - see all team members and their roles; 📅 Site Progress - view site diary entries; 📋 Action Items - track tasks assigned to you.", priority: "high" },
    { category: "🔐 Stakeholder Portal", question: "How do I view and approve meeting minutes?", answer: "If you have approval权限, you'll see an 'Approve' button when viewing minutes: 1) Go to Meetings tab, 2) Click on a meeting with 'Pending Approval' status, 3) Review the agenda, discussions, decisions, and action items, 4) Click 'Approve' to approve, or 'Reject' with feedback if changes needed. Approved minutes become official records. Rejected minutes return to draft for revision.", priority: "high" },
    { category: "🔐 Stakeholder Portal", question: "How do I know if I have tasks assigned to me?", answer: "Your dashboard shows: 📊 Overdue Tasks counter (red badge on Meetings tab), 📅 Upcoming tasks list, 📁 Action items from recent meetings. Click on any task to view details and update status (Pending → In Progress → Completed). You'll also receive email notifications when new tasks are assigned.", priority: "medium" },
    { category: "🔐 Stakeholder Portal", question: "Why am I marked as 'absent' for a meeting I attended?", answer: "Meeting attendees are recorded during minute creation. If your name is unchecked, you were marked absent. To correct: 1) Contact the minute creator (usually the project manager), 2) Request them to edit the minutes and check your name as present, 3) They can update and republish for approval. You'll receive an apology request email - you can reply with explanation if needed.", priority: "medium" },
    { category: "🔐 Stakeholder Portal", question: "Can I download documents and reports?", answer: "Yes! Most documents, drawings, photos, and reports have download buttons (↓ icon). Click to download files to your device. Some documents may open in a new browser tab instead - you can save from there. Financial reports can be exported to CSV for use in Excel.", priority: "low" },
    { category: "🔐 Stakeholder Portal", question: "What is the subdomain and why do I need it?", answer: "Your subdomain (e.g., 'fedlimited', 'bochi') identifies your company's workspace. Each company has a unique subdomain to ensure data isolation and security. You MUST enter the correct subdomain when logging in. It's provided in your invitation email and appears on the login page. Bookmark your login URL: https://bochi.ke/login?subdomain=yourcompany", priority: "medium" },
    { category: "🔐 Stakeholder Portal", question: "I didn't receive my OTP code - what should I do?", answer: "First, check your Spam/Junk folder. If still not received: 1) Wait 2 minutes and try 'Resend OTP', 2) Verify your email address is correct, 3) Check with your IT team if emails from @bochi.ke are blocked, 4) Contact your project administrator to verify your email in the system. OTPs expire in 5 minutes for security.", priority: "medium" },
    { category: "🔐 Stakeholder Portal", question: "How do I update my task status as a stakeholder?", answer: "Go to any meeting containing your task → Find the Action Items section → Click the status dropdown next to your task → Select: 'Pending' (not started), 'In Progress' (working on it), 'Completed' (finished). Completed tasks are marked with a green checkmark and removed from overdue counts.", priority: "low" },
    { category: "🔐 Stakeholder Portal", question: "What does the 'Matters Present' section mean?", answer: "The 'Matters Present' section shows all accepted team members for the project. The minute creator selects which members attended the meeting. If you were marked absent, you'll receive an automated apology request email. This helps track meeting attendance and follow up with absentees.", priority: "low" },
    { category: "🔐 Stakeholder Portal", question: "How do I sync meetings to my calendar?", answer: "In the Meetings tab, click 'Sync Calendar' button when viewing a meeting. This downloads an .ics file that you can import into Google Calendar, Outlook, Apple Calendar, or any calendar app. The file contains meeting title, date, time, location, and description.", priority: "low" },
  ];
  ...
  const stakeholderFaqs = faqs.filter(f => f.category === "🔐 Stakeholder Portal");
    ...
    <div className="space-y-6 fade-in">
      ...
      <div className="bg-gradient-to-r from-primary/15 via-primary/8 to-transparent rounded-xl p-6 border border-primary/25">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            <div className="text-center bg-blue-500/10 rounded-lg px-4 py-2">
              <p className="text-2xl font-bold text-blue-600">{stakeholderFaqs.length}</p>
              <p className="text-[10px] text-muted-foreground">Stakeholder Guides</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="critical" className="space-y-4">
        <TabsList className="flex flex-wrap">
          ...
          <TabsTrigger value="stakeholder" className="text-blue-600 font-medium">🔐 Stakeholder Portal</TabsTrigger>
        ...
        {/* ========== STAKEHOLDER PORTAL TAB (NEW) ========== */}
        <TabsContent value="stakeholder" className="space-y-4">
          <Card className="border-blue-500/30">
            <CardHeader className="bg-blue-50 dark:bg-blue-950/20">
              <CardTitle className="flex items-center gap-2 text-blue-800 dark:text-blue-400">
                <Users size={24} />
                🔐 Stakeholder Portal Guide
              </CardTitle>
              <CardDescription className="text-blue-700 dark:text-blue-400">
                Everything stakeholders (clients, architects, engineers, consultants) need to know
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6 pt-6">
              
              {/* Login Flow Diagram */}
              <div className="bg-blue-50/30 dark:bg-blue-950/30 rounded-lg p-4">
                <h3 className="font-semibold text-blue-800 dark:text-blue-400 mb-3 flex items-center gap-2">
                  <Key size={18} /> Stakeholder Login Flow (OTP - No Password!)
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-5 gap-2 text-center">
                  {[
                    { step: 1, text: "Receive Invitation Email", icon: "📧" },
                    { step: 2, text: "Click Login URL", icon: "🔗" },
                    { step: 3, text: "Enter Subdomain", icon: "🏢" },
                    { step: 4, text: "Enter Email + Send OTP", icon: "📱" },
                    { step: 5, text: "Enter OTP → Dashboard", icon: "✅" },
                  ].map((item) => (
                    <div key={item.step} className="p-2">
                      <div className="w-8 h-8 mx-auto rounded-full bg-blue-500 text-white flex items-center justify-center text-sm mb-1">{item.step}</div>
                      <div className="text-2xl mb-1">{item.icon}</div>
                      <p className="text-xs font-medium">{item.text}</p>
                    </div>
                  ))}
                </div>
                <div className="mt-3 text-center text-blue-600 dark:text-blue-400 text-sm font-semibold">
                  ⚡ No password needed - secure OTP sent to your email each login!
                </div>
              </div>

              {/* Stakeholder Features Grid */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                  <h4 className="font-semibold text-blue-700 flex items-center gap-2 mb-2"><Eye size={16} /> What Stakeholders Can View</h4>
                  <ul className="space-y-1 text-sm">
                    <li>✓ Project progress and status</li>
                    <li>✓ Meeting minutes (agenda, discussions, decisions)</li>
                    <li>✓ Project documents, drawings, photos, reports</li>
                    <li>✓ Financial summary (contract sum, invoiced, paid, outstanding)</li>
                    <li>✓ Project team members and their roles</li>
                    <li>✓ Site diary entries (progress updates)</li>
                    <li>✓ Action items assigned to you</li>
                  </ul>
                </div>
                <div className="border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                  <h4 className="font-semibold text-blue-700 flex items-center gap-2 mb-2"><Settings size={16} /> What Stakeholders Can Do</h4>
                  <ul className="space-y-1 text-sm">
                    <li>✓ Approve/reject meeting minutes (if authorized)</li>
                    <li>✓ Update assigned task status (Pending → In Progress → Completed)</li>
                    <li>✓ Download documents and reports</li>
                    <li>✓ Export calendar invites (.ics files)</li>
                    <li>✓ Receive email notifications for new tasks</li>
                    <li>✓ View real-time project progress</li>
                  </ul>
                </div>
              </div>

              {/* All Stakeholder FAQs */}
              <div className="space-y-3">
                <h3 className="font-semibold text-blue-800 flex items-center gap-2">
                  <FileQuestion size={18} /> Frequently Asked Questions for Stakeholders
                </h3>
                <Accordion type="multiple" className="w-full" value={openAccordionItems} onValueChange={setOpenAccordionItems}>
                  {stakeholderFaqs.map((faq, idx) => (
                    <AccordionItem key={idx} value={`stakeholder-${idx}`}>
                      <AccordionTrigger className="text-left hover:no-underline">
                        <div className="flex items-start gap-2">
                          <span className="text-blue-500 mt-0.5">🔐</span>
                          <span className="font-medium text-sm">{faq.question}</span>
                          {faq.priority === 'high' && (
                            <Badge variant="secondary" className="text-[10px] ml-2 bg-blue-100 text-blue-700">Important</Badge>
                          )}
                        </div>
                      </AccordionTrigger>
                      <AccordionContent className="text-muted-foreground pl-6">
              ...
              <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-3">
                <p className="text-xs font-semibold text-blue-700 mb-2 flex items-center gap-2"><Lightbulb size={14} /> Quick Tips for Stakeholders:</p>
                <ul className="space-y-1 text-xs text-muted-foreground">
                  <li>• Bookmark your login URL: https://bochi.ke/login?subdomain=YOURCOMPANY</li>
                  <li>• Check spam folder if OTP email doesn't arrive</li>
                  <li>• OTP codes expire in 5 minutes - request a new one if needed</li>
                  <li>• Update task status to 'Completed' when done to clear from overdue list</li>
                  <li>• Download meeting .ics files to add to your calendar</li>
                  <li>• Contact project manager if you see incorrect attendance marking</li>
                </ul>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-2 hover:bg-muted/30 rounded-lg"><span className="font-medium">🔐 Stakeholder Portal</span><ChevronRight size={16} className="text-muted-foreground" /></div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-start gap-2"><CheckCircle size={14} className="text-success mt-0.5" /><span><strong>OTP Authentication:</strong> Secure passwordless login for stakeholders</span></div>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-muted/30 rounded-lg p-3">
                  ...
                  <ul className="grid grid-cols-2 gap-x-4 gap-y-0.5 text-xs">
                    ...
                    <li>✓ Stakeholder Portal</li><li>✓ OTP Authentication</li>
                  </ul>
                </div>
                <div className="bg-muted/30 rounded-lg p-3">
                  ...
                  <ul className="space-y-0.5 text-xs">
                    ...
                    <li><strong>Auth:</strong> OTP-based passwordless login</li>
                  </ul>
                </div>
              </div>
